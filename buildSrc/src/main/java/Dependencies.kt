object Version {
    ...
    const val firebaseVersion = "26.6.0"
    ...
    const val dotIndicatorVersion = "4.1.2"

    const val googleMapsVersion = "17.0.0"
    const val googleMapsPlacesVersion = "16.0.0"
...
object Dependencies {
    ...
    object UI {
        ...
        const val googleMaps = "com.google.android.gms:play-services-maps:${Version.googleMapsVersion}"
        const val googleMapsPlaces = "com.google.android.gms:play-services-places:${Version.googleMapsPlacesVersion}"
        const val googleMapsLocation = "com.google.android.gms:play-services-location:${Version.googleMapsVersion}"
        const val dotsIndicator = "com.tbuonomo.andrui:viewpagerdotsindicator:${Version.dotIndicatorVersion}"
        ...
        val uiDependencies = mutableListOf(
            ...
            googleMaps, googleMapsPlaces, googleMapsLocation,dotsIndicator
        )
    }
    ...
    object Injection {
        ...
        val injectionDependencies = mutableListOf(
            dagger, fragmentNavigationInject, viewModelInject
        )
    }
